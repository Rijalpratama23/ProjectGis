  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      if (rain > 0.5) {
        ...
        colorText = '#d35400'; // Orange
      }
      if (rain > 5.0) {
        statusHujan = 'HUJAN DERAS ⛈️';
        colorText = '#c0392b'; // Merah
      }
